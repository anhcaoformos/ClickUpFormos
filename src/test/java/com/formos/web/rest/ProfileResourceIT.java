...
class ProfileResourceIT {
    ...
    void createProfile() throws Exception {
        ...
        assertThat(testProfile.getApiKey()).isEqualTo(DEFAULT_API_KEY);
        assertThat(testProfile.getToken()).isEqualTo(DEFAULT_TOKEN);
        assertThat(testProfile.getBaseUrl()).isEqualTo(DEFAULT_BASE_URL);
    }
    ...
    void putExistingProfile() throws Exception {
        ...
        assertThat(testProfile.getApiKey()).isEqualTo(UPDATED_API_KEY);
        assertThat(testProfile.getToken()).isEqualTo(UPDATED_TOKEN);
        assertThat(testProfile.getBaseUrl()).isEqualTo(UPDATED_BASE_URL);
    }
    ...
    void partialUpdateProfileWithPatch() throws Exception {
        ...
        partialUpdatedProfile.username(UPDATED_USERNAME).password(UPDATED_PASSWORD).apiKey(UPDATED_API_KEY).baseUrl(UPDATED_BASE_URL);
